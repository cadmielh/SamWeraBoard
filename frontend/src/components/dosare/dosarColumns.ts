...
export const COLUMNS: ColDef[] = [
  ...
  { key: 'profitSami',         label: 'Profit Sami',        width: 130, sortable: true,  filterable: true  },
  { key: 'profitAdi',          label: 'Profit Adi',         width: 130, sortable: true,  filterable: true  },
  ...
  { key: 'taxeOnrc',           label: 'Taxe ONRC',          width: 120, sortable: true,  filterable: true  },
  { key: 'certificatConstatator', label: 'Taxe Certificat Constatator', width: 150, sortable: true, filterable: true  },
  { key: 'tarifClient',        label: 'Tarif client',       width: 120, sortable: true,  filterable: true  },

...
export function persoanaToIDFields(p: Persoana): IDFields {
  return {
    ...
    valabila_de_la: p.valabila_de_la, valabila_pana_la: p.valabila_pana_la,
  }
}
...
export function idFieldsToPersoana(f: IDFields, source: Persoana): Persoana {
  return {
    ...
    adresa: f.adresa, judet: f.judet, emisa_de: f.emisa_de,
    valabila_de_la: f.valabila_de_la, valabila_pana_la: f.valabila_pana_la,
  }
}
